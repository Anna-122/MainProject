...
public class TCPConnection {
    ...
    public synchronized void sendSString(String value){
        try {
            out.write(value + "\r\n"); //возврат коретки и перевод строки - признак конца строки
            out.flush();//сохраняем все в буферы
        } catch (IOException e) {
            eventListener.onException(TCPConnection.this,e);
            disconnect();
        }
